...
from app.api.v1.kenali_diri.career_profile.services.user_career_profile_service import (
    UserCareerProfileService,
)
from app.api.v1.kenali_diri.career_profile.schemas.user_career_profile import (
