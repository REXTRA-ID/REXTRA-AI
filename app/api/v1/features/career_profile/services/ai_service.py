# app/api/v1/features/career_profile/services/ai_service.py
import structlog
import json
...
class CareerProfileAIService(BaseAIService):
    ...
    Menggunakan namespace 'features/career_profile'.
    """
    
    def __init__(self):
        super().__init__(namespace="features/career_profile")
